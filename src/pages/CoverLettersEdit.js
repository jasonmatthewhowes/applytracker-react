...
import { deleteCoverLetter, getCoverLetters, getSingleCoverLetter, updateCoverLetter } from "../managers/CoverLetterManager"
...
export const CoverLetterEdit = () => {
    ...
    */
    ...
    useEffect(() => {
        getSingleCoverLetter(coverLetterId).then(data => setCurrentCoverLetter(data))
    }, [])
      ...
      <form className="jobForm">
        ...
        <button
          ...
          onClick={(evt) => {
            ...
            updateCoverLetter(coverLetter).then(() =>
