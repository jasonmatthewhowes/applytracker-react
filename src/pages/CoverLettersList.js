   ...
   <tbody>
     {coverLetters.map(coverLetter => (
         <tr key={coverLetter.id}>
             ...
             <td><a href={coverLetter?.cover_letter_url} target="_blank">{coverLetter.name}</a></td>
            <td><input type="checkbox" checked={coverLetter.finalized} readOnly /></td>
             <td><button onClick={() => navigate(`/coverletters/edit/${coverLetter.id}`)}>Detail</button></td>
