...
import { createCoverLetter, deleteCoverLetter, getCoverLetters, getSingleCoverLetter, updateCoverLetter } from "../managers/CoverLetterManager"
import { getJobs } from "../managers/JobManager"
import { getAllRoles } from "../managers/RoleManager"
import "./JobsList.css"


export const CoverLetterCreate = () => {
      ...
      <form className="jobForm">
        ...
        <button
          ...
          onClick={(evt) => {
            ...
            createCoverLetter(coverLetter).then(() =>
