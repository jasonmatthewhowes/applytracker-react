  ...
  return (
    <form className="jobForm">
      ...
      <fieldset>
        ...
        >
          <option>{currentJob.company?.name}</option>
        ...
        >
          <option>{currentJob.resume?.resume_name}</option>
        ...
        >
          <option>{currentJob.cover_letter?.name}</option>
        ...
        >
          <option>{currentJob.contact?.full_name}</option>
        ...
        >
          <option>{currentJob.role?.name}</option>
          {roleList.map((option) => (
            <option key={option.id} value={option.id}>
              {option.name}
            </option>
        ...
        >
          <option>{currentJob.job_service?.name}</option>
      ...
      <button
        ...
        onClick={(evt) => {
          ...
          updateJob(job).then(() => navigate("/jobs"));
        }}
      >
        Save
      </button>
